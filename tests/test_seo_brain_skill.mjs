...
for (const required of [
  "six pillars",
  "Humans own judgment",
  "project/contents/<slug>/",
  "project/keywords/<seed>/",
  "project/audits/<slug>/",
  "project/clusters/<seed>/",
  "project/eeat/<slug>/",
  "project/wiki/",
  "browser handoff",
  "página",
  ...
  "User-directed writing is allowed",
  "Writing is not approval",
  "user-directed draft writing can proceed when clearly labeled",
