...
assert.equal(home.browser_prompt.message, "Posso abrir o Web Companion para você ver o relatório?");
assert.ok(home.report_md.endsWith("/report.md"));
assert.ok(home.report_md.startsWith("relatorios/technical-seo/"));
