...
export interface ParsedRow {
  cells: string[];
  /** Stable identity derived from the first column when possible. */
  rowKey: string | null;
}
...
function extractRowKeyFromCell(cell: string): string | null {
...
export function parseMaterializedTable(markdown: string): ParsedTable {
