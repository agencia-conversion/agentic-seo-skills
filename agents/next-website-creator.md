...
After scaffolding, run relevant build or file validation when dependencies exist. Keep site content aligned with the project brain (`project/brain/identity.md`, `project/brain/voice.md`, `project/brain/editorial.md`, etc.).
