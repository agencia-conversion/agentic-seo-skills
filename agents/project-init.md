---
name: project-init
description: Initializes Agentic SEO project with the required folder layout, blank brain templates, conteudos directories, and first log entry. Use when creating a new project.
