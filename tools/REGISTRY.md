# Agentic SEO Tools Registry

| tool | category | upstream-source | status | agentic-seo-version | notes |
|---|---|---|---|---|---|
...
| `site-import` | Batch site importer | original | shipped | 0.2.0 | Sitemap discovery + extract.js + URL classification → `project/contents/<origin>/<slug>.md` com frontmatter `contract_version: 1`. Idempotente. Usado pela skill `content-import`. |
...
| `similarweb` | Competitive traffic | `coreyhaines31/marketingskills@906c2fb28e471c5b1d149d4159ec5ddb40b7c364` | candidate | pending | Candidate only if useful for SEO evidence. |
| `keywords-everywhere` | Keyword data | `coreyhaines31/marketingskills@906c2fb28e471c5b1d149d4159ec5ddb40b7c364` | candidate | pending | Candidate lightweight alternative. |
| `airops` | Workflow automation | `coreyhaines31/marketingskills@906c2fb28e471c5b1d149d4159ec5ddb40b7c364` | candidate | pending | Defer unless a concrete Agentic SEO workflow needs it. |
