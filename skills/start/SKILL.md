...
Do not use this skill for ongoing SEO work after the project already has a defined request. Route those requests through `agentic-seo` and the next step that owns the work.
...
Route: project-init | agentic-seo | <next-step>
