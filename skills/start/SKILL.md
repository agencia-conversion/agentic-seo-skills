...
Output: Route to `agentic-seo` because the request spans multiple pillars. Name likely gates such as DataForSEO credentials, approved strategy, source capture, and technical audit.
