...
function additionalContext(input) {
  ...
  return [
    ...
    "Skills de dados e análises — `seo-analysis`, `technical-seo`, `backlink-analysis`, `keyword-research`, `serp-extract`, `internal-links`, `eeat`, `topic-cluster` — devem sempre aplicar `page-report`, escrever `report.md` em `project/analyses/` e oferecer abertura pelo prompt de chat.",
