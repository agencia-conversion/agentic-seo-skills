...
Agentic SEO is officially available as a Claude Code plugin.
...
```bash
claude plugin marketplace add agencia-conversion/agentic-seo
claude plugin install agentic-seo@agentic-seo-marketplace
```
...
```bash
claude plugin marketplace update agentic-seo-marketplace
claude plugin update agentic-seo@agentic-seo-marketplace
```
...
```bash
git clone https://github.com/agencia-conversion/agentic-seo.git
cd agentic-seo
claude --plugin-dir .
```
...
Agentic SEO is officially supported only as a Claude Code plugin in v0.1.
...
Agentic SEO organizes Agentic SEO around six pillars:
...
- GitHub repository: `agencia-conversion/agentic-seo`
- Claude Code marketplace: `.claude-plugin/marketplace.json`
- Claude Code plugin id: `agentic-seo@agentic-seo-marketplace`
